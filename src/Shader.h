...
const std::unordered_map<std::string, UniformID> uniform_string2id_ = {
    ...
    { "u_projection_matrix", U_PROJECTION_MATRIX },
    { "u_tex_noise", U_TEX_NOISE },
    { "samples", U_RANDOM_SAMPLES },
    { "u_tex_ssao", U_TEX_SSAO },
...
public:
    ...
    bool setUniform(UniformID id, const lm::vec3& data, int count);
